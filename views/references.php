...
<div class="vision1">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div class="thumbnail">
                    <img src="../img/007.png" alt="Content marketing" style="width:40%">

                </div>
            </div>
            <div class="col-md-4">
                <div class="thumbnail">
                    <img src="../img/008.png" alt="Relations publiques et presse" style="width:40%">
            ...
            <div class="col-md-4">
                <div class="thumbnail">
                    ...
                    <img src="../img/009.png" alt="" style="width:40%">
                </div>
            </div>
            <div class="col-md-4">
                <div class="thumbnail">

                    <img src="../img/010.png" alt="Fjords" style="width:40%">
            ...
            <div class="col-md-4">
                <div class="thumbnail">
                    ...
                    <img src="../img/011.png" alt="Fjords" style="width:40%">
            ...
            <div class="col-md-4">
                <div class="thumbnail">
                    ...
                    <img src="../img/012.png" alt="Fjords" style="width:40%">
                </div>
            </div>
            <div class="col-md-4">
                <div class="thumbnail">

                    <img src="../img/013.png" alt="Fjords" style="width:40%">
                </div>
            </div>
            <div class="col-md-4">
                <div class="thumbnail">

                    <img src="../img/014.png" alt="Fjords" style="width:40%">
                </div>
            </div>
            <div class="col-md-4">
                <div class="thumbnail">
