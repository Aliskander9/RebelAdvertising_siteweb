...
<div class="vision1"></br>
     ...
     <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="thumbnail">
                    <a href="" target="_blank">
                        <img src="../img/003.png" alt="" style="width:20%">
                        <div class="caption">
            ...
            <div class="col-md-4">
                <div class="thumbnail">
                    <a href="" target="_blank">
                        <img src="../img/004.png" alt="Fjords" style="width:22%">
                        <div class="caption">
            ...
            <div class="col-md-4">
                <div class="thumbnail">
                    <a href="" target="_blank">
                        <img src="../img/005.png" alt="Fjords" style="width:25%">
                        <div class="caption">
            ...
            <div class="col-md-4">
                <div class="thumbnail">
                    <a href="" target="_blank">
                        <img src="../img/006.png" alt="Fjords" style="width:18%">
                        <div class="caption">
    ...
    <?php
    if (!empty( $_SESSION['email'])) {
        echo '<a href="commandes.php" class="comm"><input type="button" value="Commander" class="btn btn-warning" ></a>';
    }
    else {
        echo '<a href="connexion.html" class="comm"><input type="button" value="Commander" class="btn btn-warning"></a>';
    }
    ?>
