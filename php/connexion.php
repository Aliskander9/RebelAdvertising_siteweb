    ...
    if(empty($_POST['email'])) {
        ...
        if(empty($_POST['mdp'])) {
            ...
            if(!$mysqli){
                ...
                $Requete = mysqli_query($mysqli,"SELECT * FROM users WHERE email = '".$email."' AND mdp = '".$mdp."'");//si vous avez enregistré le mot de passe en md5() il vous suffira de faire la vérification en mettant mdp = '".md5($MotDePasse)."' au lieu de mdp = '".$MotDePasse."'
